...
-- Show the colour column at 81 (standard is to keep code within 80 characters)
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local filetypes = {
        'bash', 'c', 'css', 'diff', 'go', 'html', 'htmldjango',
        'javascript', 'lua', 'luadoc', 'markdown', 'markdown_inline',
        'python', 'query', 'rust', 'templ', 'typescript', 'vim', 'vimdoc', 'zig',
      }
